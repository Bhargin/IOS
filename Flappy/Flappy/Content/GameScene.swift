...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createRocks() {
        ...
        // 2
        let rockCollision = SKSpriteNode(color: UIColor.red, size: CGSize(width: 20, height: 20))
        ...
        rockCollision.position = CGPoint(x: xPosition + (rockCollision.size.width * 6) + 20, y:  CGFloat(arc4random_uniform(UInt32(frame.height - 20))) + 70)
